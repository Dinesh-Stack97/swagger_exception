...
* The original package name 'Sping_Boot_Hibernate_MySQL_CRUD_REST_API .Spring_Boot_CURD' is invalid and this project uses 'Sping_Boot_Hibernate_MySQL_CRUD_REST_API.Spring_Boot_CURD' instead.
